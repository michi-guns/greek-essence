---
id: GE-008.05
title: '/packages/[slug]/request interstitial + buildFormUrl() prefill helper'
status: To Do
assignee: []
...
Planning ref: T-03.5 (docs/v1/04-ROADMAP.md)
est: 60/105/210 min (min/avg/max)
Phase P3.1 - Product lane

/packages/[slug]/request interstitial + buildFormUrl() prefill helper
