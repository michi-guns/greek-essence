---
id: GE-009.03
title: 'Shared content-page template → /about, /contact, /privacy, /terms'
status: To Do
assignee: []
...
Planning ref: T-03.8 (docs/v1/04-ROADMAP.md)
est: 60/105/210 min (min/avg/max)
Phase P3.2 - Product lane

Shared content-page template → /about, /contact, /privacy, /terms
