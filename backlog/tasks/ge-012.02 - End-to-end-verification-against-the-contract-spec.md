---
id: GE-012.02
title: End-to-end verification against the contract spec
status: To Do
assignee: []
...
Planning ref: T-04.10 (docs/v1/04-ROADMAP.md)
est: 45/90/180 min (min/avg/max)
Phase P4.3 - Junior lane

End-to-end verification against the contract spec: all 3 forms, both emails, Sheet rows, redirect
