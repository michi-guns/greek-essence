...
| Work program map                 | Cold-start “what next” map, frontier tasks, soft pull order; Trello remains Work Unit authority              | [`working/work-program/SEQUENCE.md`](working/work-program/SEQUENCE.md)                               |
| Docs + Next.js architecture plan | Grilling-locked docs tiers and Next.js feature-first seats; migration-v4 inspiration only                    | [`working/DOCS_AND_NEXTJS_ARCHITECTURE_PLAN.md`](working/DOCS_AND_NEXTJS_ARCHITECTURE_PLAN.md)       |
