...
| Q11 | **Netlify housekeeping** — rename the site off `frolicking-pie-16b7ba`, set env vars, enable credit alerts at 50%/75% (Node version reconciled: 24 everywhere, 2026-09-23) | Operator | Before first production deploy |
