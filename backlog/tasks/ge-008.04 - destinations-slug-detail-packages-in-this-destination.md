---
id: GE-008.04
title: '/destinations/[slug] detail + packages in this destination'
status: To Do
assignee: []
...
Planning ref: T-03.4 (docs/v1/04-ROADMAP.md)
est: 60/105/210 min (min/avg/max)
Phase P3.1 - Product lane

/destinations/[slug] detail + packages in this destination
